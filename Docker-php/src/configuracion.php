...
$conexion=mysqli_connect($hostname,$user,$pass,"centrodiscusion");
...
$consulta="INSERT INTO usuarios(nombre,apellidos,dni,email,pass) VALUES('adminu','adminu','00000000X','adminu@admin.admin','$pass2');";
$ejecutar_consulta=mysqli_query($conexion,$consulta);
